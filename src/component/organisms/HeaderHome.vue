<template>
	<header class="container d-flex align-items-center flex-column flex-md-row py-5 ">
		<div class="d-flex flex-column justify-content-center align-items-start col col-md-8 mt-4 mt-md-0 color-bg">
		...
		<div class=" col col-md-4 d-flex justify-content-end mt-3 mt-md-0  text-white">
